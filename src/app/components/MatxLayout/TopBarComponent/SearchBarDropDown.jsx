...
const discoverMore = [
  ...
  "free shipping items",
  "man shoes",
  "smartwatch free shipping smartwatch free shipping smartwatch free shipping smartwatch free shipping smartwatch free shipping",
...
const recommendations = [
  {
    title: "Used Phones",
    image:
      "https://ae-pic-a1.aliexpress-media.com/kf/S64b0e089852041fc8af3e4de4e6dd54ag.jpg_220x220q75.jpg_.avif",
  },
  {
    title: "Iphone",
    image:
  ...
  {
    title: "Mobile Phone Chargers",
    image:
      "https://ae-pic-a1.aliexpress-media.com/kf/S64b0e089852041fc8af3e4de4e6dd54ag.jpg_220x220q75.jpg_.avif",
  },
];

const SearchBarDropDown = memo(
  forwardRef(({ navigates, searchBarMenuPosition }, ref) => {
      ...
      >
                  ...
                  {res.result.map((resEl) => (
                    <Box
                      ...
                      sx={{
                        cursor: "pointer",
                        "&:hover": {
                          backgroundColor: "rgba(240, 237, 237, 0.8)",
                        },
                      }}
                      display={"flex"}
                      padding={1}
                      ...
                      onClick={() => resEl.nav && window.open("" + resEl.nav)}
                    >
                      {resEl.img && (
                        <Box
                          component="img"
                        ...
                        {resEl.price && (
                          ...
                          >
                            <Typography
                              variant="body2"
                              sx={{
                                textDecoration: resEl.discount
                                  ? "line-through"
                                  : "none",
                              }}
                            >
                              {formatToLKR(resEl.price)}
                            </Typography>
                            {resEl.discount && (
                              <Typography
                                variant="body2"
        ...
        {searchHistory && searchHistory.length > 0 && (
          <Box>
            <Box
              ...
              mb={1}
              sx={{
                background: lighten(themeColors.red.palette.primary.main, 0),
                color: "white",
              }}
            >
              <Typography
            ...
            <Button
              sx={{ position: "relative", right: "0.5em", color: themeColors.red.palette.secondary.main }}
              // variant='text'
              variant="text"
              size="small"
              // onClick={fun}
...

        {
          <Box>
            ...
            <Grid container spacing={1} p={1} flexWrap={"wrap"}>
              <Grid item xs={3}>
                <Typography variant="subtitle1" fontWeight="bold">
                  Hot topics
                </Typography>
                <List dense sx={{ pr: 0, pl: 0 }}>
